...
const SCHEDULE_RULES: RulesSection[] = [
  {
    ...
    items: [
      'REGOLA PRIORITARIA: ogni dipendente ha un minimo di giorni smart OGNI settimana in cui è presente (default 2, configurabile nelle Impostazioni). Nessuno resta in ufficio per settimane intere. Questa regola batte ferie ed equità.',
      'L\'ufficio si riempie al minimo a ⌈capienza/3⌉ e al massimo alla capienza, ma non deve per forza essere pieno: se saturarlo toglierebbe lo smart minimo, resta più vuoto (almeno 1 persona però c\'è sempre).',
      'Oltre al minimo settimanale, lo smart in eccesso è bilanciato per equità sullo "smart-equivalente" (smart reali + ferie): chi è sopra la media va in ufficio — ma mai sotto il minimo settimanale.',
